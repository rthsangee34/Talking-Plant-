      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="hidden sm:inline">{language === 'en' ? 'EN / தமிழ்' : 'தமிழ் / EN'}</span>
          ...
          {/* Dropdown Menu */}
          {langDropdownOpen && (
            <div className="absolute right-0 mt-2 w-36 rounded-2xl liquid-glass border border-white/80 shadow-xl p-1.5 z-50 animate-in fade-in zoom-in-95 duration-150">
              <button
